        ...
        <div className="max-w-5xl mx-auto grid md:grid-cols-3 gap-10">
          ...
          <div>
            ...
            <nav className="flex flex-col gap-2">
              {["Fixtures", "News", "About", "Parent Portal"].map((link) => (
                <a
                  key={link}
                  href="#"
          ...
          <div>
            ...
            <div className="flex flex-col gap-3">
              <a href="mailto:info@bradwellfc.co.uk" className="flex items-center gap-2 text-sm text-secondary-foreground/60 hover:text-primary transition-colors">
                <Mail size={14} />
